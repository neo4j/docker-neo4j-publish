...
if [ "${cmd}" == "neo4j" ]; then
    ...
    echo >&2 "
=======================================================
 Neo4j Red Hat UBI9 images are deprecated in favour of Red Hat UBI10.
 Update your codebase to use Neo4j Docker image tags ending with -ubi10 instead of -ubi9.

 This is the last Neo4j image available on Red Hat UBI9.
 By continuing to use UBI9 tagged Neo4j images you will not get further updates, 
